...
let input = ['format', 'formula', 'hyperlink', 'index', 'style', 'validation', 'value', 'wrap'];
let outputs = [];
/**
...
let input$3 = ['dataSource', 'query', 'range', 'showFieldAsHeader', 'startCell', 'template'];
let outputs$3 = [];
/**
...
let input$4 = ['activeCell', 'colCount', 'columns', 'index', 'isProtected', 'name', 'protectSettings', 'rangeSettings', 'rowCount', 'rows', 'selectedRange', 'showGridLines', 'showHeaders', 'state', 'topLeftCell', 'usedRange'];
let outputs$4 = [];
/**
