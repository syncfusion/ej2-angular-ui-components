...
let input$4 = ['cFColor', 'format', 'range', 'type', 'value'];
let outputs$4 = [];
/**
...
let input$5 = ['activeCell', 'colCount', 'columns', 'conditionalFormats', 'index', 'isProtected', 'name', 'protectSettings', 'ranges', 'rowCount', 'rows', 'selectedRange', 'showGridLines', 'showHeaders', 'state', 'topLeftCell', 'usedRange'];
let outputs$5 = [];
/**
...
let input$6 = ['comment', 'name', 'refersTo', 'scope'];
let outputs$6 = [];
/**
