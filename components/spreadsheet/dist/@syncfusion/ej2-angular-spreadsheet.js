...
let input = ['colSpan', 'format', 'formula', 'hyperlink', 'index', 'isLocked', 'rowSpan', 'style', 'validation', 'value', 'wrap'];
let outputs = [];
/**
...
let input$1 = ['cells', 'customHeight', 'height', 'hidden', 'index'];
let outputs$1 = [];
/**
...
let input$2 = ['customWidth', 'hidden', 'index', 'width'];
let outputs$2 = [];
/**
...
let input$4 = ['activeCell', 'colCount', 'columns', 'index', 'isProtected', 'name', 'protectSettings', 'ranges', 'rowCount', 'rows', 'selectedRange', 'showGridLines', 'showHeaders', 'state', 'topLeftCell', 'usedRange'];
let outputs$4 = [];
/**
