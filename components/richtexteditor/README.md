...
<div align="center">
    <h4>
        ...
        <a href="https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/tools?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm">🚀Online demos</a> &#x2022; 
...
| [<img src="https://ej2.syncfusion.com/github/images/js.svg" height="50" />](https://www.syncfusion.com/javascript-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[JavaScript](https://www.syncfusion.com/javascript-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)&nbsp;&nbsp;&nbsp;&nbsp; | [<img src="https://ej2.syncfusion.com/github/images/react.svg"  height="50" />](https://www.syncfusion.com/react-components?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[React](https://www.syncfusion.com/react-components?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | [<img src="https://ej2.syncfusion.com/github/images/vue.svg" height="50" />](https://www.syncfusion.com/vue-components?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Vue](https://www.syncfusion.com/vue-components?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | [<img src="https://ej2.syncfusion.com/github/images/netcore.svg" height="50" />](https://www.syncfusion.com/aspnet-core-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)<br/>&nbsp;&nbsp;[ASP.NET&nbsp;Core](https://www.syncfusion.com/aspnet-core-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)&nbsp;&nbsp; | [<img src="https://ej2.syncfusion.com/github/images/netmvc.svg" height="50" />](https://www.syncfusion.com/aspnet-mvc-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)<br/>&nbsp;&nbsp;[ASP.NET&nbsp;MVC](https://www.syncfusion.com/aspnet-mvc-ui-controls?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)&nbsp;&nbsp; | 
| :-----: | :-----: | :-----: | :-----: | :-----: |

## 🏗️ Showcase samples

* [Angular HTML editor demo](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/tools?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [Blog posting using angular rich text editor demo](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/blog-posting?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [Angular Markdown editor demo](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/markdown-editor?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [Angular live HTML editor demo](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/online-html-editor?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)

## ✨ Key features

* [Edit mode](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/iframe?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - HTML content is possible to edit in a `div` element or an `iframe` in the rich text editor.

* [@Mentions](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/mention-integration?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Easily mention users, tags, or items with an autocomplete suggestion list.

* [Slash Menu Support](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/smart-suggestion?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Quickly insert content blocks using the `/` command.

* [Checklist Suport](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/tools?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Allows users to create checklists (to-do lists) directly within the editor. Users can easily add interactive checkbox items to their content.
...
* [HTML code editing](https://ej2.syncfusion.com/aspnetcore/documentation/rich-text-editor/code-view-support?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - The rich text editor allows users to edit the HTML code directly in the HTML code view.

* [Markdown editor](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/tools?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - The rich text editor allows you to edit Markdown content using the Markdown syntax.
...
* [Export and Import](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/rich-text-editor/export-document?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Supports exporting content to PDF, and Word formats.

* [Copy and paste](https://ej2.syncfusion.com/angular/documentation/rich-text-editor/paste-cleanup?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Copy and paste from Microsoft Word, Outlook, or other editors or sources while preserving formatting, styles, and structure.
...
* [Documentation](https://ej2.syncfusion.com/angular/documentation/rich-text-editor/getting-started?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [Theme Studio](https://ej2.syncfusion.com/themestudio/?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [What's New](https://www.syncfusion.com/products/whatsnew/angular?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [Road Map](https://www.syncfusion.com/products/roadmap/angular?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
* [E-Books](https://www.syncfusion.com/succinctly-free-ebooks?searchkey=angular&type=all?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)

## 🤝 Support

Product support is available through the following mediums.

* [Support ticket](https://support.syncfusion.com/support/tickets/create?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm) - Guaranteed Response in 24 hours | Unlimited tickets | Holiday support
...
* [GitHub issues](https://github.com/syncfusion/ej2-angular-ui-components/issues/new?utm_source=npm&utm_medium=listing&utm_campaign=angular-rich-text-editor-npm)
