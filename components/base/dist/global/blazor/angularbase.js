window.sf = window.sf || {};
window.sf.angularbase = (function (exports) {
'use strict';
...
function registerEvents(eventList, obj, direct) {
    ...
    if (eventList && eventList.length) {
        for (var _i = 0, eventList_1 = eventList; _i < eventList_1.length; _i++) {
            ...
            if (direct === true) {
                obj.propCollection[event_1] = new core.EventEmitter(false);
                obj[event_1] = obj.propCollection[event_1];
            }
            else {
                ngEventsEmitter[event_1] = new core.EventEmitter(false);
            }
        }
        if (direct !== true) {
...
var ComplexBase = /** @class */ (function () {
    ...
    ComplexBase.prototype.ngOnInit = function () {
        ...
        for (var _i = 0, _a = this.tags; _i < _a.length; _i++) {
            var tag = _a[_i];
            var objInstance = sf.base.getValue('child' + tag.substring(0, 1).toUpperCase() + tag.substring(1), this);
            if (objInstance) {
        ...
        for (var _b = 0, templateProperties_1 = templateProperties; _b < templateProperties_1.length; _b++) {
            ...
            sf.base.setValue(propName.replace('_', '.'), sf.base.getValue(propName, this), this.propCollection);
        }
        ...
        if (this.directivePropList) {
            for (var k = 0; k < this.directivePropList.length; k++) {
                ...
                if (propList.indexOf(dirPropName) !== -1) {
                    sf.base.setValue(dirPropName, sf.base.getValue(dirPropName, this), this.propCollection);
                }
            }
...
var ComponentBase = /** @class */ (function () {
    ...
    ComponentBase.prototype.ngOnInit = function (isTempRef) {
        ...
        tempOnThis.createElement = function (tagName, prop) {
            //tslint:disable-next-line
            var ele = tempOnThis.srenderer ? tempOnThis.srenderer.createElement(tagName) : sf.base.createElement(tagName);
            ...
            if (prop.attrs !== undefined) {
                sf.base.attributes(ele, prop.attrs);
            }
            return ele;
        };
        for (var _i = 0, _a = tempOnThis.tags; _i < _a.length; _i++) {
            var tag = _a[_i];
            var tagObject = {
                instance: sf.base.getValue('child' + tag.substring(0, 1).toUpperCase() + tag.substring(1), tempOnThis),
                name: tag
            };
        ...
        for (var _b = 0, complexTemplates_1 = complexTemplates; _b < complexTemplates_1.length; _b++) {
            ...
            var propName = tempName.replace('Ref', '');
            var val = {};
            sf.base.setValue(propName.replace('_', '.'), sf.base.getValue(propName, tempOnThis), val);
    ...
    ComponentBase.prototype.ngAfterContentChecked = function (isTempRef) {
        ...
        for (var _i = 0, _a = tempAfterContentThis.tagObjects; _i < _a.length; _i++) {
            var tagObject = _a[_i];
            if (!sf.base.isUndefined(tagObject.instance) &&
    ...
    ComponentBase.prototype.twoWaySetter = function (newVal, prop) {
        ...
        sf.base.setValue(prop, (sf.base.isNullOrUndefined(newVal) ? null : newVal), this.properties);
        sf.base.getValue(prop + 'Change', this).emit(newVal);
    };
    ComponentBase.prototype.addTwoWay = function (propList) {
        var _this = this;
        var _loop_1 = function (prop) {
            sf.base.getValue(prop, this_1);
            Object.defineProperty(this_1, prop, {
                get: function () {
                    return sf.base.getValue(prop, _this.properties);
                },
                set: function (newVal) { return _this.twoWaySetter(newVal, prop); }
            });
            sf.base.setValue(prop + 'Change', new core.EventEmitter(), this_1);
        };
        var this_1 = this;
    ...
    ComponentBase.prototype.addEventListener = function (eventName, handler) {
        var eventObj = sf.base.getValue(eventName, this);
        if (!sf.base.isUndefined(eventObj)) {
    ...
    ComponentBase.prototype.trigger = function (eventName, eventArgs, success) {
        ...
        var localEventObj = sf.base.getValue('local' + eventName.charAt(0).toUpperCase() + eventName.slice(1), this);
        if (!sf.base.isUndefined(localEventObj)) {
...
function setter(key) {
    return function (val) {
        ...
        sf.base.setValue(key + 'Ref', val, this);
...
function getter(key, defaultValue) {
    return function () {
        /* istanbul ignore next */
        return sf.base.getValue(key + 'Ref', this) || defaultValue;
    };
}
//tslint:disable-next-line
