...
let input: string[] = ['col', 'content', 'cssClass', 'enabled', 'header', 'id', 'maxSizeX', 'maxSizeY', 'minSizeX', 'minSizeY', 'row', 'sizeX', 'sizeY'];
let outputs: string[] = [];
/**
...
export class PanelDirective extends ComplexBase<PanelDirective> {
     ...
     */
    public sizeY: any;
    @ContentChild('panelHeader')
    @Template()
    public panel_header: any;
    @ContentChild('panelContent')
    @Template()
    public panel_content: any;
