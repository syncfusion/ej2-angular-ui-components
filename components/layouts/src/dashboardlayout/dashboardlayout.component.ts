...
export const inputs: string[] = ['allowDragging','allowFloating','allowPushing','allowResizing','cellAspectRatio','cellSpacing','columns','draggableHandle','enablePersistence','enableRtl','locale','mediaQuery','panels','resizableHandles'];
export const outputs: string[] = ['change','drag','dragStart','dragStop','resize','resizeStart','resizeStop'];
