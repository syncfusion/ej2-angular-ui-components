...
* New [GitHub issue](https://github.com/syncfusion/ej2-angular-inputs/issues/new).
...
Check the changelog [here](https://github.com/syncfusion/ej2-angular-inputs/blob/master/CHANGELOG.md?utm_source=npm&utm_campaign=input)
