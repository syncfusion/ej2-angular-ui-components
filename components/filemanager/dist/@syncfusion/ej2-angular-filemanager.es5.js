...
var inputs = ['ajaxSettings', 'allowMultiSelection', 'contextMenuSettings', 'cssClass', 'detailsViewSettings', 'enablePersistence', 'enableRtl', 'height', 'locale', 'navigationPaneSettings', 'path', 'searchSettings', 'selectedItems', 'showFileExtension', 'showHiddenItems', 'showThumbnail', 'toolbarSettings', 'uploadSettings', 'view', 'width'];
var outputs = ['beforeFileLoad', 'beforeFileOpen', 'beforeSend', 'created', 'destroyed', 'fileSelect', 'menuClick', 'menuOpen', 'onError', 'onSuccess', 'toolbarClick'];
var twoWays = [''];
/**
