...
export const inputs: string[] = ['calendarMode','dayHeaderFormat','depth','enablePersistence','enableRtl','firstDayOfWeek','isMultiSelection','keyConfigs','locale','max','min','showTodayButton','start','value','values','weekNumber'];
